...
xtrain = X_normalized[indices[best_score_ind][0]]
ytrain = y.iloc[indices[best_score_ind][0]]
xtest = X_normalized[indices[best_score_ind][1]]
ytest = y.iloc[indices[best_score_ind][1]]
...
joblib.dump(rf_model, 'crop_yield.pkl')
...
print(f"Crop yield model saved successfully!")
